<template>
    <jet-action-section>
        ...
        <template #description>
            Gestisci o elimina le tue sessioni attive in altri browser o dispositivi.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Se necessario, puoi disconnetterti da tutte le altre sessioni browser su tutti i tuoi dispositivi. Alcune delle tue sessioni recenti sono elencate di seguito; Tuttavia, questo elenco potrebbe non essere esaustivo. <strong>Se ritieni che il tuo account sia stato compromesso, dovresti anche aggiornare la tua password</strong>.
            </div>
            ...
            <div class="flex items-center mt-5">
                <jet-button @click="confirmLogout">
                    Elimina le altre sessioni browser
                </jet-button>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Perfavore inserisci la password per confermare l'eliminazione delle altre sessioni browser dei tuoi dispositivi.
