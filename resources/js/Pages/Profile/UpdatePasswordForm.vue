<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            Assicurati che il tuo account utilizzi una password lunga e sicura.
        </template>

        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" value="Password attuale" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" value="Nuova password" />
